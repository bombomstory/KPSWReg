...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="evaluationDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-star me-1"></i>
                            ประเมินครู
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="evaluationDropdown">
                            <li><a class="dropdown-item" href="#" onclick="evaluateAdvisor()">
                                <i class="bi bi-person-check"></i> ประเมินครูที่ปรึกษา
                            </a></li>
                            <li><a class="dropdown-item" href="#" onclick="evaluateSubjectTeacher()">
                                <i class="bi bi-book-half"></i> ประเมินครูผู้สอน
                            </a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <section class="hero-section">
        ...
        <div class="container position-relative">
            <h1 class="display-4">ยินดีต้อนรับสู่แดชบอร์ดนักเรียน</h1>
    ...
    <section id="dashboard" class="container">
        <div class="dashboard-container fade-in">
            ...
            <div class="menu-grid">
                ...
                <div class="menu-card slide-up" onclick="showTeacherEvaluation()">
                    <!-- <div class="menu-icon" style="background: linear-gradient(135deg, #ff9a9e 0%, #fad0c4 100%);"> -->
                        <div class="menu-icon">
                        <!-- <i class="bi bi-star-fill"></i> -->
                        <i class="bi bi-star"></i>
                    </div>
                    <h5 class="menu-title">ประเมินครู</h5>
                    <p class="menu-description">ให้คะแนนและข้อเสนอแนะสำหรับครูที่ปรึกษาและครูผู้สอน</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="footer-content">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p><i class="bi bi-geo-alt me-2"></i>123 ถนนกำแพงแสน อำเภอกำแพงแสน จังหวัดนครปฐม 73140</p>
                        <p><i class="bi bi-telephone me-2"></i>034-281-234</p>
                        <p><i class="bi bi-envelope me-2"></i>info@kswit.ac.th</p>
                    </div>
                    <div class="col-md-4">
                        <h5>เมนูหลัก</h5>
                    ...
                    <div class="col-md-4">
                        ...
                        <p><i class="bi bi-envelope me-2"></i>support@kswit.ac.th</p>
                    </div>
                </div>
