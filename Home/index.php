            ...
            <div class="footer-content">
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <h5 class="footer-title"><img src="images/KPSWLogo.png" alt="โรงเรียนกำแพงแสนวิทยา" class="fas fa-graduation-cap me-2" width="40"> โรงเรียนกำแพงแสนวิทยา</h5>
                        <p class="text-muted">สถานศึกษาที่มุ่งเน้นการพัฒนาการเรียนรู้ด้วยเทคโนโลยี เพื่อเตรียมความพร้อมสู่อนาคต</p>
                    ...
                    <div class="col-lg-2 col-md-6 mb-4">
                        ...
                        <a href="#" class="footer-link">เกี่ยวกับโรงเรียน</a>
                        <a href="#" class="footer-link">บริการ</a>
                        <a href="#" class="footer-link">ข่าวสาร</a>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <p class="footer-link"><i class="fas fa-phone me-2"></i>034-XXX-XXX</p>
                        <p class="footer-link"><i class="fas fa-envelope me-2"></i>info@kpsw.ac.th</p>
                    </div>
                </div>
            </div>
            
            <div class="footer-bottom">
                <p>&copy; 2568 โรงเรียนกำแพงแสนวิทยา สงวนลิขสิทธิ์ | พัฒนาโดยทีมไอที</p>
            </div>
        </div>
    </footer>
